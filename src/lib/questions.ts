...
export const podniesienieJakosciNauczania = [
  ...
  { id: "2.6", title: "Autorstwo i realizacja programu nowego przedmiotu", points: 2, tooltip: [] },
  ...
  { id: "2.10", title: "Jakość prowadzenia zajęć dydaktycznych (arkusze hospitacji)", points: "Zależy od średniej ocen uzyskanych w okresie oceny", tooltip: [] },
  { id: "2.11", title: "Jakość prowadzenia zajęć dydaktycznych (ankiety studenckie i doktoranckie)", points: "Zależy od uzyskanej średniej ocen", tooltip: [] },
  { id: "2.12", title: "Promotorstwo prac dyplomowych licencjackich lub inżynierskich", points: 2, tooltip: [] },
  { id: "2.13", title: "Promotorstwo prac dyplomowych magisterskich", points: 3, tooltip: [] },
  { id: "2.14", title: "Przygotowanie recenzji prac licencjackich, inżynierskich lub magisterskich", points: 0.5, tooltip: [] },
  { id: "2.15", title: "Prowadzenie dodatkowych zajęć sportowych", points: 5, tooltip: [] },
  { id: "2.16", title: "Przygotowanie przedmiotu w systemie e-learningowym", points: 3, tooltip: [] },
  { id: "2.17", title: "Organizacja i przeprowadzenie centralnego egzaminu językowego", points: 3, tooltip: [] }
];
...
export const zajeciaJezykObcy = [
  ...
  { id: "3.3", title: "Konsultacje ze studentami zagranicznymi w języku obcym", points: 0.5, tooltip: [] }
];

export const funkcjeDydaktyczne = [
  { id: "4.1", title: "Członkostwo w Uczelnianej komisji ds. jakości kształcenia", points: 5, tooltip: [] },
  { id: "4.2", title: "Członkostwo w Wydziałowej komisji ds. jakości kształcenia", points: 5, tooltip: [] },
...
export const publikacjeDydaktyczne = [
  ...
  { id: "1.3", title: "Autorstwo skryptu", points: 20, tooltip: [] },
  { id: "1.4", title: "Autorstwo artykułu/monografii (dotyczy pracowników dydaktycznych)", points: "Punktacja wg systemu bibliotecznego", tooltip: [] },
  { id: "1.5", title: "Tłumaczenie podręcznika akademickiego na język polski", points: 15, tooltip: [] },
  { id: "1.6", title: "Tłumaczenie skryptu na język polski", points: 10, tooltip: [] },
  ...
  { id: "1.8", title: "Autorstwo rozdziału w podręczniku akademickim", points: 5, tooltip: [] },
